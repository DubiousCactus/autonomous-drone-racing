...
\todo{Talk about the code being given maybe?}
...
by resizing it to $255\times340\timesC$, corresponding to $255$ rows of the
input tensor for the image height, $340$ for the columns of the tensor and the
image with, and lastly $C$ channels to be set wether a grayscale or an RGB
input image is used.\\
...
Adam optimizer is used with its default hyperparameters.
