...
- Talk about the dimensions of the lab
- Describe how the gates are spawned in a constrained space of the same
dimensions
\begin{equation} \label{equ:modelviewmatrix}
	M_{modelView} = M_{view} \dot M_{model}
\end{equation}
...
- Describe how the scale is relative to the unitless OpenGL system
