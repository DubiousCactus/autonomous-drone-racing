...
\draw[thick] ($(vicon.south east)!0.33!(vicon.north east)$) -| node[yshift=2em,
    xshift=-10.5em]{\emph{pose}} ($(pid.north west)!0.33!(pid.north east)$);
\draw[thick] ($(vicon.north east)!0.33!(vicon.south east)$) -| (safety.north);
...
\draw[thick] ($(median.south east)!0.33!(median.south west)$) --
    node[xshift=5em, yshift=-.5em]{\emph{filtered prediction}} ++(0,-2cm)
